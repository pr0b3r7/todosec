...
* [Linux](cloud-and-networked-systems-topics/linux/)
...
* [Routing and Switching](cloud-and-networked-systems-topics/routing-and-switching/)
  * [350-401 ENCOR: Implementing Cisco Enterprise Network Core Technologies](cloud-and-networked-systems-topics/routing-and-switching/350-401-encor-implementing-cisco-enterprise-network-core-technologies/)
...
* \*\*\*\*[**Code**](cloud-and-networked-systems-topics/code/)\*\*\*\*
  * \*\*\*\*[**Bash**](cloud-and-networked-systems-topics/code/code-bash/)\*\*\*\*

    1. [wip-W1nn13PwnWifi.sh](cloud-and-networked-systems-topics/code/code-bash/wip-w1nn13pwnwifi.sh.md)
    2. [Basic Examples of Bash Scripting](cloud-and-networked-systems-topics/code/code-bash/basic-examples-of-bash-scripting.md)
    3. [Check for live hosts in a /24 network](cloud-and-networked-systems-topics/code/code-bash/ping-sweeping-with-bash.md)
    ...
    * [Language Fundamental Series](cloud-and-networked-systems-topics/code/code-python/language-fundamentals-series/)
      ...
      2. [How to install python2.7 in kali 5.10.0-kali6-amd64](cloud-and-networked-systems-topics/code/code-python/language-fundamentals-series/how-to-install-python2.7-in-kali-5.10.0-kali6-amd64.md)
      3. [Python 2 vs Python 3](cloud-and-networked-systems-topics/code/code-python/language-fundamentals-series/python-2-vs-python-3-wip/)
    ...
    1. \*\*\*\*[forloop.py](cloud-and-networked-systems-topics/code/code-python/scripts/forloop.py.md)
    2. [BackdoorClient.py](cloud-and-networked-systems-topics/code/code-python/scripts/backdoorclient.py.md)
    3. [BackdoorServer.py](cloud-and-networked-systems-topics/code/code-python/scripts/backdoorserver.py.md)
    4. [PortScanner.py](cloud-and-networked-systems-topics/code/code-python/scripts/portscanner.py.md)
    5. [TcpClient.py](cloud-and-networked-systems-topics/code/code-python/scripts/tcpclient.py.md)
    6. [TcpServer.py](cloud-and-networked-systems-topics/code/code-python/scripts/tcpserver.py.md)
    7. [HttpGo-Getter.py](cloud-and-networked-systems-topics/code/code-python/scripts/httpgo-getter.py.md)
    8. [HttpEnum-Client.py](cloud-and-networked-systems-topics/code/code-python/scripts/httpenum-client.py.md)
