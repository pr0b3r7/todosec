...
* [Controls](infosec/controls/README.md)
  * [macOS](infosec/controls/macos/README.md)
    * [README](infosec/controls/macos/macos.md)
  * [Windows](infosec/controls/windows/README.md)
    * [README](infosec/controls/windows/windows.md)
  * [Linux](infosec/controls/linux/README.md)
    * [README](infosec/controls/linux/linux.md)
* [Post-Exploitation](infosec/post-exploitation/README.md)
  * [AWS](infosec/post-exploitation/aws/README.md)
    * [C2](infosec/post-exploitation/aws/c2.md)
    * [Collection](infosec/post-exploitation/aws/collection.md)
    * [Credential AccessS](infosec/post-exploitation/aws/credential-access.md)
  ...
  * [Azure](infosec/post-exploitation/azure/README.md)
  ...
  * [GCP](infosec/post-exploitation/gcp/README.md)
  ...
  * [Linux](infosec/post-exploitation/linux/README.md)
  ...
  * [Windows](infosec/post-exploitation/windows/README.md)
    ...
    * [Execution](infosec/post-exploitation/windows/execution.md)
  ...
  * [macOS](infosec/post-exploitation/macos/README.md)
    ...
    * [Execution](infosec/post-exploitation/macos/execution.md)
...
* [Boxes](infosec/boxes/README.md)
  * [HTB](infosec/boxes/htb/README.md)
    * [OSCP \(TJNull's\)](infosec/boxes/htb/htb-oscp--tjnull/README.md)
      * [First Box](infosec/boxes/htb/htb-oscp--tjnull/first-box.md)
    * [OSWE \(TJNull's\)](infosec/boxes/htb/htb-oswe-tjnull/README.md)
      * [First Box](infosec/boxes/htb/htb-oswe-tjnull/first-box.md)
  * [Vulnhub](infosec/boxes/vulnhub/README.md)
    * [OSCP Giveaway](infosec/boxes/vulnhub/oscp-giveaway.md)
    * [OSCP \(TJNull's\)](infosec/boxes/vulnhub/oscp-tjnull/README.md)
      * [First Box](infosec/boxes/vulnhub/oscp-tjnull/first-box.md)
    * [OSWE \(TJNull's\)](infosec/boxes/vulnhub/oswe-tjnulls/README.md)
      * [First Box](infosec/boxes/vulnhub/oswe-tjnulls/first-box.md)
* [Infrastructure](infosec/infrastructure/README.md)
  * [Defensive/BLUE](infosec/infrastructure/defensive-blue/README.md)
    * [Linux Logs](infosec/infrastructure/defensive-blue/linux-logs.md)
  * [Offensive/RED](infosec/infrastructure/offensive-red/README.md)
    * [README](infosec/infrastructure/offensive-red/offensive-red.md)

## Network and Systems

* [Code](network-and-systems/code/README.md)
  * [Bash](network-and-systems/code/code-bash/README.md)
    * [Basic examples of Bash Scripting](network-and-systems/code/code-bash/basic-examples-of-bash-scripting.md)
    * [Ping Sweeping with Bash](network-and-systems/code/code-bash/ping-sweeping-with-bash.md)
    * [wip-W1nn13PwnWifi.sh](network-and-systems/code/code-bash/wip-w1nn13pwnwifi.sh.md)
  * [Python](network-and-systems/code/code-python/README.md)
    * [Scripts](network-and-systems/code/code-python/scripts/README.md)
      * [forloop.py](network-and-systems/code/code-python/scripts/forloop.py.md)
      * [BackdoorClient.py](network-and-systems/code/code-python/scripts/backdoorclient.py.md)
      * [BackdoorServer.py](network-and-systems/code/code-python/scripts/backdoorserver.py.md)
      * [PortScanner.py](network-and-systems/code/code-python/scripts/portscanner.py.md)
      * [TcpClient.py](network-and-systems/code/code-python/scripts/tcpclient.py.md)
      * [TcpServer.py](network-and-systems/code/code-python/scripts/tcpserver.py.md)
      * [HttpGo-Getter.py](network-and-systems/code/code-python/scripts/httpgo-getter.py.md)
      * [HttpEnum-Client.py](network-and-systems/code/code-python/scripts/httpenum-client.py.md)
    * [Language Fundamentals Series](network-and-systems/code/code-python/language-fundamentals-series/README.md)
      * [Python 2 vs Python 3](network-and-systems/code/code-python/language-fundamentals-series/python-2-vs-python-3-wip/README.md)
        * [Python2and3code.py](network-and-systems/code/code-python/language-fundamentals-series/python-2-vs-python-3-wip/python2and3code.py.md)
  * [Powershell](network-and-systems/code/code-powershell.md)
* [Network](network-and-systems/network/README.md)
  * [Routing and Switching](network-and-systems/network/routing-and-switching/README.md)
    * [350-401 ENCOR: Implementing Cisco Enterprise Network Core Technologies](network-and-systems/network/routing-and-switching/350-401-encor-implementing-cisco-enterprise-network-core-technologies/README.md)
      * [Exam Topics](network-and-systems/network/routing-and-switching/350-401-encor-implementing-cisco-enterprise-network-core-technologies/exam-topics.md)
...
* [macOS](network-and-systems/macos/README.md)
  * [README](network-and-systems/macos/macos.md)
* [Windows](network-and-systems/windows/README.md)
  * [Windows Basic Networking](network-and-systems/windows/windows-basic-networking.md)
* [Linux](network-and-systems/linux/README.md)
